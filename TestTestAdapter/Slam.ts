...
export function run(grunt: any, command: string): Q.Promise<void> {
...
export function cleanVsInstance(grunt: any, options: Options): Q.Promise<void> {
    ...
    }).then(command => run(grunt, command));
}
...
export function resetTestVS(grunt: any, options: Options): Q.Promise<void> {
